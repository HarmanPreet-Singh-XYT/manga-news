...
export default function SeriesPage() {
  ...
  const fanFavorites = [
    { id: 11, title: "Hunter X Hunter", rating: 9.7, image: "https://m.media-amazon.com/images/M/MV5BYzYxOTlkYzctNGY2MC00MjNjLWIxOWMtY2QwYjcxZWIwMmEwXkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg", genre: "Adventure", isNew: false, isTrending: false, episodes: 148 },

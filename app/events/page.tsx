    ...
    style={{ 
      ...
      <main className="container mx-auto px-4 py-8 relative">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          {/* Sidebar with Manga Style */}
          <div className="lg:w-1/3">
            {/* Calendar Widget styled as manga panel */}
            ...
            {/* Manga-style sidebar announcement */}
      ...
      {/* Back to Top Button with Manga Style */}
      {showBackToTop && (
        <button 
          onClick={scrollToTop}

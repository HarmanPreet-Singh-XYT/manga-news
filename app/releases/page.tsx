...
export default function MangaNewsPage() {
  ...
  return (
    <div className={`min-h-screen ${themeClass} font-sans transition-colors duration-300`}>
      ...
      {/* NEWSLETTER */}
      <section className="container mx-auto px-4 py-6">
        <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} p-6 clip-path-polygon relative  border-2 ${darkMode ? 'border-pink-500' : 'border-violet-600'} transform -rotate-1`}>
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-2">
              <input 
                ...
                className={`flex-1 p-3 ${darkMode ? 'bg-gray-700 border-gray-600' : 'bg-gray-100 border-gray-300'}    border rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 ${darkMode ? 'focus:ring-pink-500' : 'focus:ring-violet-500'}`}
              />
